    ...
    <div class="image-container">
        ...
        <div class="w3-margin">
            <h2 class="w3-text-black">
                <strong>SISTEM INFORMASI MESIN PENCARI GAMBAR UKUR</strong>
            </h2>
        ...
        <form action="" method="post">
            <div class="mb-3 mt-3 links-container">
                <input type="text" class="form-control" placeholder="Nama" style="width: 50%;" name="nmpemohon" autocomplete="off" required>
                <?php
                $year = date("Y");
                ?>
                ...
                <button type="submit" name="search-nama" style="width: 50%;" class="w3-button w3-hover-blue w3-large w3-black">CARI GU</button>
                <a href="searching_nomor.php">Cari GU Berdasarkan Nomor</a>
        </form>
        ...
        if (isset($_POST['search-nama'])) {
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM tbl_gu WHERE nmpemohon='$nmpemohon' && tahun='$tahun'");
